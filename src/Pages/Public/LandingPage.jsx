...
import { MapPin, Users, Car, Shield, ChevronDown, Building2, Settings, CircleDot } from "lucide-react";
...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="container mx-auto px-6 py-4">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="bg-orange-600 p-2.5 rounded-lg shadow-md relative">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-orange-600 font-medium -mt-0.5">Road Safety Platform</p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3 items-center relative">
                                        ...
                                        <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden z-50">
                                            ...
                                            <div className="p-2">
                                                {loginOptions.map((option, index) => (
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-3">
                                                            <div className={`w-10 h-10 ${option.color} rounded-md flex items-center justify-center text-white`}>
                            ...
                            <Link
                                to="/register"
                                className="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 shadow-md hover:shadow-lg transition-all font-medium"
                            >
                                Register
                            </Link>
                        </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                    {[
                        ...
                        <div key={index} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                            <div className="text-3xl font-semibold text-orange-600">{stat.value}</div>
            ...
            {/* CTA Section */}
            <section className="container mx-auto px-6 py-16">
                <div className="bg-orange-600 rounded-xl p-12 text-center text-white shadow-xl">
                    ...
                    <Link
                        to="/register"
                        className="inline-block px-6 py-3 bg-white text-orange-600 rounded-md font-medium hover:bg-gray-100 transition"
                    >
                        Get Started Free →
                    </Link>
                </div>
            ...
            <footer className="bg-gray-900 text-white py-8">
                <div className="container mx-auto px-6 text-center">
                    <div className="flex items-center justify-center gap-3 mb-3">
                        ...
                        <h1 className="text-lg font-bold">Turn The Wheel</h1>
                    </div>
